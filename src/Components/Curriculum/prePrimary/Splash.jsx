...
import book1 from "../../../assets/curriculum/splash/splash.png";
import logo from "../../../assets/curriculum/splash/splashIcon.png";
import img6 from "../../../assets/curriculum/zoom/key features.png";
import img4 from "../../../assets/curriculum/zoom/oslite.png";
import img7 from "../../../assets/curriculum/splash/9.png";
...
const Splash = () => {
  ...
  return (
    ...
    >
      <Banner2 image={book1} bgColor={"#ca76e3"} />
      ...
      <div className="flex sm:flex-row flex-col justify-center px-8 bg-gray-200">
        <MainContent
          ...
          para={
            <span>
              <span className="font-bold text-purple-700">SPLASH:</span> makes
              children conversant with concepts and ideas pertaining to
              awareness about the environment. It sets ground to build on
              observation, sequential thinking, and socio-emotional attitudes.
              The series assists learners to discover their surroundings and
              develop their cognitive capacity. The Early Childhood Learning
              Programme based on integrated and experiential learning promotes
              creative thinking in young learners. It is designed by experienced
              teachers adhering to the elements of Multiple Intelligences and
              Bloom's Taxonomy. Our activity-based books and notebooks give
              children the opportunity to explore, understand, and enjoy
              learning. They follow an interactive approach and aim to build
              learner independence right from an early age.
            </span>
          }
          bgColor={"#ca76e3"}
          listOne={"NURSERY"}
      ...
      <div className="flex flex-col justify-center items-center bg-[#ca76e3]">
        <div
          ref={keyFeatures}
          id="keyFeature"
          ...
          <SectionTwo
            content={
              <Content
                ...
                points={[
                  "Object Identification and Association: Develops ability to recognise, name, and recall concepts, ideas, and objects.",
                  "Creative Appreciation: Builds ability to think creatively and express.",
                  "Independent Thinking and Problem Solving: Interesting child-friendly activities that enhance higher order thinking skills (HOTS).",
                  "Visual Memory: Tasks that develop the ability to distinguish between objects, pictures and physical characteristics.",
                ]}
              />
            }
            bgColor={"rgb(202, 118, 227)"}
            img={img6}
          />
        </div>
      </div>
      <div className="flex flex-row justify-center items-center p-4 sm:w-full">
        <img src={img7} className="w-[60%] h-auto" alt="" />
      </div>
      <div className="flex flex-row justify-center items-center">
        <CardThree bgColor={"#ca76e3"} bgColor1={"#ad6bc2"} />
      </div>
