...
import book1 from "../../../assets/curriculum/cbse/grammar_com_vibes/grammar vibes.png";
import logo from "../../../assets/curriculum/cbse/grammar_com_vibes/logo.png";
    ...
    >
      ...
      <div className="flex sm:flex-row flex-col justify-center px-8 bg-gray-200">
        <MainContent
          ...
          para={
            <span>
              <span className="font-bold text-[#ee4d9b]">
              ...
              strategies have been used to incorporate 21st century skills such
              as critical thinking, creativity, and communication in addition to
              life skills within the series. The series has an unbroken wire
              frame for learning by providing core, supplemental, and home
              learning solutions on the same platform.
            </span>
          }
          bgColor={"rgb(238, 77, 155)"}
          listOne={"Grades"}
          ...
          <Section
            content={
              <KeyPoints
                ...
                points={[
                  "Spiralling gradation of grammar concepts enabling easy comprehension",
                  "Easy-to-understand examples using real-life scenarios",
                  "Concepts explained using flowcharts and graphic organizers",
                  "Exercises to evaluate learners’ understanding of concepts and to develop real-life skills and create awareness about social and global issues",
                  "Let Us Revise pages providing additional practice",
                  "Comprehension topics to develop reading skills followed by application exercises",
                  "Composition exercises to help learners write independently",
                  "Formats for Writing pages in Grades 6–8 for quick recapitulation of writing skills",
                  "Series matches the linguistic needs for the syllabi of all boards and schools",
                ]}
              />
            }
            bgColor={"rgb(238, 77, 155)"}
...
export default Grammar_com_vibes;
